...
\begin{frame}[fragile]{Syntax}
	...
	\begin{itemize}[<+-|alert@+>]
		...
		\item Umgebungen:\\ \verb|\begin{typ} \dots \end{typ}|, \\z.B. \verb|\begin{enumerate} \dots \end{enumerate}|
	\end{itemize}
	...
	\begin{itemize}[<+-|alert@+>]
		\item \textit{preamble}
			\begin{itemize}
				...
				\item Metadaten (z.B. \verb|\autor|) $\rightarrow$ darstellen mit \verb|\maketitle|
