...
Das Bild \texttt{beispiel.png} liegt hier in einem Ordner \texttt{Downloads}.\\ Zusätzlich kann die Größe des Bildes durch {\color{blue} \verb|"width="|} angegeben werden, in diesem Fall ist das Bild 50 \% so groß, wie der Text, auch kann man sich auf die Texthöhe mit {\color{blue}\verb|"height=\textheight"|} beziehen. \\
...
% TODO(bpeetz): Soll man hier vllt die wirkliche number referenzieren, statt 1 hardzucoden?
...
\underline{Beispiel:}\\
% TODO(bpeetz): Ergibt hier `\cdot{}` statt dem '×' Sinn, weil es ja nicht gerendert wird?
